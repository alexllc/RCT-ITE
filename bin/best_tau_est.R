        ...
        for (imp_type_Y in 1:3) {
            ...
            for (iter in 1:Q) {
                ...
                if(tuned_cb_param) {
                    ...
                    cb_param_tune_res <- read.csv(paste0("./dat/cb_param/", trial, imputation_methods[imp_type_Y], "_", outcome, "_", iter, "_cb_param.csv")) # if skipping parameters tuning, we will use the previously tuned parameter for this trial
                ...
                write.csv(compare_rloss, paste0("./res/", trial, "_model_sel_", imputation_methods[imp_type_Y], "_", outcome, "_", iter, "_res.csv"), row.names = TRUE)
            } # end of CV fold loop
        } # end of imputation type loop
